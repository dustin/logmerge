 ...
 *
 * $Id: mymalloc.h,v 1.4 2002/06/05 19:26:58 dustin Exp $
 */
...
char   *_my_strdup(const char *str, char *file, int line);
char   *_mymalloc_assert(void *str, char *file, int line);
...
#define mymalloc_assert(a) _mymalloc_assert(a, __FILE__, __LINE__)

#else

#define mymalloc_assert(a)
